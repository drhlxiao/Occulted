...
class OCProperties(object):
    ...
    def get_T_EM(self,ID, free=True): #read in the fit... use IDL cuz I'm too lazy to sift through the whole .fits file for the right keywords
